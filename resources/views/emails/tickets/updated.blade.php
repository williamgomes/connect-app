...
<html>
    <head>
        ...
        <title>{{ __('A new comment has been added to your ticket:') }} {{ $ticket->title }} (#{{ $ticket->id}})</title>
        <style>
            /* -------------------------------------
                                        ...
                                        <tr>
                                            <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                                <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                                                    ...
                                                    <br>
                                                    <br>
                                                    <a href="{{ action('Web\TicketController@show', $ticket) }}">{{ __('Click here to view the comment.') }}</a>
                                                    <br>
                                                    <br>
                                                    <br>
                                                    <small>
